...
def synchroMosaique(trial_folder):
    ...
    mosaic_path = os.path.join(trial_folder, "SyncVideos.mp4")
    ...
    output_with_text_path = os.path.join(trial_folder, "SyncVideos_with_text.mp4")
    text_commands = ""
...
synchroMosaique(r"C:\Videos_Markerless\Manip_3x3_ext_24-10-2024\Manip 3_traitement\Trial_6\videos_raw")
